...
public class IceGolemModel<T extends IceGolemEntity> extends EntityModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(VanillaGolems.MOD_ID, ModEntityTypes.ICE_GOLEM_ID), "main");
    ...
    public IceGolemModel(ModelPart pRoot) {
        this.root = pRoot;
